...
func (s *internalWorkerTestSuite) TestWorkflowTaskHandlerWithDataConverter() {
	...
	params := workerExecutionParameters{
		...
		Identity:      "identity",
		Logger:        logger,
		DataConverter: iconverter.NewPayloadLimitDataConverter(iconverter.NewTestDataConverter(), logger),
		cache:         cache,
	}
...
func TestWorkerOptionDefaults(t *testing.T) {
	...
	expected := workerExecutionParameters{
		...
		DataConverter:                  iconverter.NewPayloadLimitDataConverter(converter.GetDefaultDataConverter(), workflowWorker.executionParameters.Logger),
