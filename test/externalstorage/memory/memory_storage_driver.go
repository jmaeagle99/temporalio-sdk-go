...
func (driver *memoryStorageDriver) Store(ctx context.Context, payloads []*commonpb.Payload) ([]externalstorage.ExternalStorageClaim, error) {
...
func (driver *memoryStorageDriver) Retrieve(ctx context.Context, claims []externalstorage.ExternalStorageClaim) ([]*commonpb.Payload, error) {
