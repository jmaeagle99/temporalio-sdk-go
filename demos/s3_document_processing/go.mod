module go.temporal.io/sdk/demos/s3_document_processing
...
replace (
	go.temporal.io/sdk => ../../
	go.temporal.io/sdk/contrib/aws/s3driver => ../../contrib/aws/s3driver
	go.temporal.io/sdk/contrib/aws/s3driver/awssdkv2 => ../../contrib/aws/s3driver/awssdkv2
)
